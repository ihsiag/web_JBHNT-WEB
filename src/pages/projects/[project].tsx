    ...
    <>
      <div className="component">
        <ul className="dataBlocks">
          <li className="year"><p>{tagData.year.toString().toUpperCase()},</p></li>
          <li className="client"><p>{tagData.client.toUpperCase()},</p></li>
          <li className="abst"><p>{tagData.abstract.toUpperCase()},</p></li>     
          <li className="tags">
      ...
      <div className="component">
        {mediumData.map((data, index) => {
          return (
            ...
            <div className="mediaCaption"><p>{data.caption}</p></div>
            </div>
          );
        })}
      </div>
  ...
  <div className="component">
    ...
    {otherProjects.map((p,_i)=>(
      <div className="otherProjectContainer" key={`InParts_OtherProjects_${p.id}_${_i}`}>
        <Link href = {`/projects/${p.asUrl.toLowerCase()}`} scroll ={false}><a>
